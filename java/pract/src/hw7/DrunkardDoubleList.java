...
public class DrunkardDoubleList {
    ...
    private static LinkedList<Integer> firstPlayerHand;
    private static LinkedList<Integer> secondPlayerHand;

    public static void main(String[] args) {
        firstPlayerHand = new LinkedList<Integer>();
        secondPlayerHand = new LinkedList<Integer>();
